              ...
              <div key={index} className="w-full flex flex-col gap-2">
                {field.type !== "textArea" && (
                  <input
                    ...
                    className="border-2 border-slate-400 focus:outline-none focus:border-yellow-300 px-4 lg:px-6 py-2 md:py-4 rounded-md placeholder:text-black placeholder:font-medium w-full"
                  />
                )}
